...
(
	PersonagenmId INT PRIMARY KEY IDENTITY,
...
INSERT INTO Usuarios VALUES ('Bora', 'Senha1234');
...
--BUSCAR EMAIL INDIVIDUAL
SELECT Email, Senha FROM Usuarios WHERE Email = 'Teste';

-- ALTERAÇÃO NOS DADOS
UPDATE Usuarios SET Email = 'Teste Alterado'	WHERE UsuarioId = 2;
